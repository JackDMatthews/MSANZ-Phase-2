...
class AMLPipelinesAPI10(object):
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_pipeline_endpoint_submit_by_pipeline_run_id_post(
        ...
        if pipeline_version is not None:
            # Please keep these lines, refer to the service api definition for more details at:
            # https://msdata.visualstudio.com/Vienna/_git/vienna?path=/src/aether/platform/backendV2/BlueBox/AE3pService/Service/Controllers/PipelineRunsController.cs&version=GBmaster&line=1235&lineEnd=1250&lineStartColumn=1&lineEndColumn=43&lineStyle=plain&_a=contents
            pipeline_version = self._serialize.query("pipeline_version", pipeline_version, 'str')
            url = f"{url}/{pipeline_version}" if pipeline_version else url
            query_parameters['pipelineVersion'] = pipeline_version
