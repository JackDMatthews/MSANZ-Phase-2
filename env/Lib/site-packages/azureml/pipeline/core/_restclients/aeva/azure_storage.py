...
class AzureStorage(object):
    ...
    def upload_file(blob_name, sas_uri, file_path):
        ...
        blob_service.get_blob_client(
            ...
            blob=blob_name
        ).upload_blob(stream, blob_type="BlockBlob")
        stream.close()
    ...
    def download_from_azure(storage_account_key, blob_uri, file_path):
        ...
        with open(file_path, 'wb') as my_blob:
            download_stream = blob_service.get_blob_client(
                container=container_name,
                blob=blob_name
            ).download_blob()
