...
class Estimator(MMLBaseEstimator):
    ...
    defined environment or an Azure ML curated environment. For an introduction to configuring
    experiment runs with ScriptRunConfig, see `Configure and submit training runs
    <https://docs.microsoft.com/azure/machine-learning/how-to-set-up-training-targets?view=azure-ml-py>`_.
    ...
    def __init__(self,
        ...
        """
        module_logger.warning("'Estimator' is deprecated. Please use 'ScriptRunConfig' from "
                              "'azureml.core.script_run_config' with your own defined environment or an Azure ML "
                              "curated environment.")
