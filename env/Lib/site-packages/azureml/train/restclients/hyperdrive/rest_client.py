...
class RestClientConfiguration(Configuration):
    ...
    def __init__(
        ...
        # Note: Change the hardcoded service version when updating the base_rul
        self.add_user_agent('Hyperdrive.Service/1.0.0')
        self.add_user_agent('Hyperdrive.SDK/{}'.format(VERSION))
...
class RestClient(object):
    ...
    def create_experiment_with_custom_run_id(
            self, run_id, config, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.create_experiment_with_custom_run_id.metadata['url']
        path_format_arguments = {
            'arm_scope': self._serialize.url("self.config.arm_scope", self.config.arm_scope, 'str'),
            'run_id': self._serialize.url("run_id", run_id, 'str')
        }
        ...
        return deserialized
    create_experiment_with_custom_run_id.metadata = {'url': '/{arm_scope}/hdruns/{run_id}'}
