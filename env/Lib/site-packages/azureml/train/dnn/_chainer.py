...
class Chainer(_FrameworkBaseEstimator):
    ...
    defined environment or one of the Azure ML Chainer curated environments. For an introduction to
    configuring experiment runs with ScriptRunConfig, see `Configure and submit training runs
    ...
    def __init__(self,
        ...
        """
        module_logger.warning("'Chainer' estimator is deprecated. Please use 'ScriptRunConfig' from "
                              "'azureml.core.script_run_config' with your own defined environment or "
                              "one of the Azure ML Chainer curated environments.")
