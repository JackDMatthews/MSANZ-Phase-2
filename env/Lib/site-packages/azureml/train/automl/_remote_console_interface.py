...
class RemoteConsoleInterface:
    ...
    def __init__(self,
                 ...
                 file_logger: Optional[Union[logging.Logger, logging.LoggerAdapter]] = None,  # type: ignore
    ...
    def print_pre_training_progress(
            self, parent_run: 'AutoMLRun',
            file_logger=None  # type: Optional[Union[logging.Logger, logging.LoggerAdapter[Any]]]
            ) -> None:  # noqa: E123
        """
    ...
    def _show_output(current_run: 'AutoMLRun',
                     logger: ConsoleWriter,
                     file_logger: Optional[Union[logging.Logger, logging.LoggerAdapter]],  # type: ignore
