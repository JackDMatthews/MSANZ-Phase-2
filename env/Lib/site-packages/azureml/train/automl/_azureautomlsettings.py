...
class AzureAutoMLSettings(AutoMLBaseSettings):
    ...
    def __init__(self,
        ...
        # Whether to enable parallelization for batched runs.
        self.enable_parallel_run = kwargs.pop('enable_parallel_run', False)

        # Sets how many processes to use for parallel batched runs.
        self.num_procs = kwargs.pop('num_procs', None)
        ...
        self.enable_code_generation = kwargs.pop('enable_code_generation', True)
