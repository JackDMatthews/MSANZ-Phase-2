...
class HTSForecastQuantilesInputExtraArguments(ArgumentInvalid):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.HIERARCHY_QUANTILE_FORECAST_INPUT_EXTRA_ARGS
...
class QuantileForecastRollingModeNotSupported(NotSupported):
    @property
    def message_format(self):
        return AutoMLErrorStrings.QUANTILE_FORECAST_ROLLING_MODE_UNSUPPORTED


class QuantileForecastAggregationNotSupported(NotSupported):
    @property
    def message_format(self):
        return AutoMLErrorStrings.HIERARCHY_QUANTILE_FORECAST_AGGREGATION_UNSUPPORTED
...
class UniqueDataInValidation(BadData):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.UNIQUE_VALUE_CROSS_VALIDATION
...
@error_decorator(use_parent_error_code=True)
class TCNWrapperDeadlockError(AutoMLInternal):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.TCN_DEADLOCK_ERROR
