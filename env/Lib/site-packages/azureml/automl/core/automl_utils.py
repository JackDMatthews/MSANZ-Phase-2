...
from azureml.automl.core.constants import SDKResourceURLSEnvironmentVariables
...
def get_automl_resource_url():
    """This function returns the resource url where models are hosted in the current region"""
    resource_url = os.getenv(SDKResourceURLSEnvironmentVariables.AUTOML_SDK_RESOURCE_URL_NAME,
                             default=SDKResourceURLSEnvironmentVariables.AUTOML_SDK_RESOURCE_URL_DEFAULT)
    if resource_url[-1] != '/':
        resource_url += '/'
    return resource_url
